...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(140, 100, 641, 511))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.genre_combo_box = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.ege_essay_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
        self.ege_essay_btn.setObjectName("ege_essay_btn")
        self.horizontalLayout.addWidget(self.ege_essay_btn)
        self.final_essay_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
        self.final_essay_btn.setObjectName("final_essay_btn")
        self.horizontalLayout.addWidget(self.final_essay_btn)
        ...
        self.add_essay_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.view_literature_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.view_authors_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.view_essays_btn = QtWidgets.QPushButton(parent=self.layoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ege_essay_btn.setText(_translate("MainWindow", "Сочинения ЕГЭ"))
        self.final_essay_btn.setText(_translate("MainWindow", "Итоговое сочинение"))
        ...
        self.view_literature_btn.setText(_translate("MainWindow", "Посмотреть все \n"
                                                                  "произведения"))
        self.view_authors_btn.setText(_translate("MainWindow", "Посмотреть \n"
                                                               "всех авторов"))
